  ...
  <header class="sticky top-0 z-50 border-b border-ln-border bg-ln-surface/80 backdrop-blur-md">
    <div class="max-w-5xl mx-auto px-5 sm:px-8 h-14 flex items-center justify-between">
      ...
      <NuxtLink to="/" class="text-ln-text">
        <svg width="120px" height="148px" viewBox="0 0 496 148" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          <title>Group 6</title>
          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <g id="Desktop-HD" transform="translate(-97.000000, -666.000000)" fill-rule="nonzero">
                  <g id="Group-6" transform="translate(97.405063, 666.000000)">
                      ...
                      <polygon id="Path" fill="#FF1EE6" points="31.7629055 0 7.10760662 78.8585043 26.9789129 78.8585043 3.26516943e-13 148 74.8401889 57.3517272 43.9349963 57.3517272 84.3037975 8.34401992e-14"></polygon>
                  </g>
              </g>
          </g>
        </svg>
